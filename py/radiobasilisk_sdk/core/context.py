...
from radiobasilisk_sdk.core.helpers import get_ctx_prop, to_map
...
class RadioBasiliskContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = RadioBasiliskControl()
        ...
        if isinstance(sp, RadioBasiliskSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, RadioBasiliskResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RadioBasiliskResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return RadioBasiliskError(code, msg, self)
