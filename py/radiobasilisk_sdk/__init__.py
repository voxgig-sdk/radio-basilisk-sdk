...
from radiobasilisk_sdk.utility import register

# Load features
from radiobasilisk_sdk.feature.base_feature import RadioBasiliskBaseFeature
from radiobasilisk_sdk.features import _has_feature, _make_feature
...
class RadioBasiliskSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = RadioBasiliskUtility()
        self._utility = utility

        from radiobasilisk_sdk.config import shared_config
    ...
    def get_utility(self):
        return RadioBasiliskUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RadioBasiliskSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Music(self, data=None) -> "MusicEntity":
        ...
        from radiobasilisk_sdk.entity.music_entity import MusicEntity
        return MusicEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "RadioBasiliskSDK":
        if sdkopts is None:
            sdkopts = {}
