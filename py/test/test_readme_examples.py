# RadioBasilisk SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RadioBasiliskSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RadioBasiliskSDK(...) and RadioBasiliskSDK.test(...) become
#      RadioBasiliskSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "radiobasilisk_sdk"
_SDK_CLASS = "RadioBasiliskSDK"
