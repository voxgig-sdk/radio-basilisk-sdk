# RadioBasilisk SDK Music entity
...
class MusicEntity
  ...
  def data_set(args)
    if args
      @_data = RadioBasiliskHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  def match_set(args)
    if args
      @_match = RadioBasiliskHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  # @return [Array<Music>, Array] the matching Music items; raises RadioBasiliskError on failure
