...
class MusicEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set RADIOBASILISK_TEST_MUSIC_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def music_basic_setup(extra)
  ...
  entid_env_raw = ENV["RADIOBASILISK_TEST_MUSIC_ENTID"]
