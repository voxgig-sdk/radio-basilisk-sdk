...
#      offline in seeded test mode (RadioBasiliskSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "RadioBasilisk_sdk.rb")
  SDK_CLASS = "RadioBasiliskSDK"
