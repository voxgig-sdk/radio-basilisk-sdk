# RadioBasilisk Ruby SDK Reference

Complete API reference for the RadioBasilisk Ruby SDK.
...
```ruby
require_relative 'radio-basilisk_sdk'
...
#### `RadioBasiliskSDK.test(testopts = nil, sdkopts = nil)`
