...
func (sdk *RadioBasiliskSDK) OptionsMap() map[string]any {
...
func (sdk *RadioBasiliskSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *RadioBasiliskSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *RadioBasiliskSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RadioBasiliskSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *RadioBasiliskSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *RadioBasiliskSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("RadioBasiliskSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *RadioBasiliskSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RadioBasiliskSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("RadioBasiliskSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *RadioBasiliskSDK {
	...
	sdk := NewRadioBasiliskSDK(sdkopts)
	sdk.Mode = "test"
