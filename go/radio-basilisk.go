...
// instead of `sdk.NewRadioBasiliskSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *RadioBasiliskSDK  { return NewRadioBasiliskSDK(nil) }
func Test() *RadioBasiliskSDK { return TestSDK(nil, nil) }
