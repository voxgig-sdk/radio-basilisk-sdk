// Command RadioBasilisk-mcp is an MCP server exposing the RadioBasilisk
// SDK as MCP tools.
//
// Two tools are registered:
//
//	RadioBasilisk_list  — list records of an entity
//	RadioBasilisk_load  — load a single record of an entity
//
