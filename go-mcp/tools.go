...
type Args struct {
	Entity string         `json:"entity" jsonschema:"music"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.RadioBasiliskSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "radio-basilisk_list",
		Description: "List records from RadioBasilisk. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "radio-basilisk_load",
		Description: "Load a single record from RadioBasilisk. " +
...
func runOp(client *sdk.RadioBasiliskSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.RadioBasiliskSDK, name string) (sdk.RadioBasiliskEntity, error) {
