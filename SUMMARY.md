...
| --- | --- | --- | --- |
| Music | `list` | `GET /songs/recently-played` | See reference |

## Connect to the API

- Production server: `https://www.basilisk.ch/api`
...
- `radio-basilisk_list`: List records for an entity. Supported entities: `music`.
- `radio-basilisk_load`: Load one record for an entity. No active entity supports this operation.
