...
(0, node_test_1.describe)('MusicDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('RADIO_BASILISK_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.RadioBasiliskSDK({
...
function liveScenariosActive() { return false && process.env.RADIO_BASILISK_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.RadioBasiliskSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['RADIO_BASILISK_TEST_MUSIC_ENTID'];
    ...
    const client = new __1.RadioBasiliskSDK({
        base: 'http://localhost:8080',
