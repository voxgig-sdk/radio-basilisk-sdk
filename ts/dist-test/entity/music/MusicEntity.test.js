...
(0, node_test_1.describe)('MusicEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.RadioBasiliskSDK.test();
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set RADIO_BASILISK_TEST_MUSIC_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    let client = __1.RadioBasiliskSDK.test(options, extra);
    ...
    const idmapEnvVal = process.env['RADIO_BASILISK_TEST_MUSIC_ENTID'];
    ...
    if (live) {
        client = new __1.RadioBasiliskSDK(merge([
