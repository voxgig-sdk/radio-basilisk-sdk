...
function envOverride(m) {
    if ('TRUE' === process.env.RADIO_BASILISK_TEST_LIVE ||
        'TRUE' === process.env.RADIO_BASILISK_TEST_OVERRIDE) {
    ...
    m.RADIO_BASILISK_TEST_EXPLAIN = process.env.RADIO_BASILISK_TEST_EXPLAIN || m.RADIO_BASILISK_TEST_EXPLAIN;
    return m;
}
