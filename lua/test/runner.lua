...
function runner.env_override(m)
  local live = runner.getenv("RADIO_BASILISK_TEST_LIVE")
  local override = runner.getenv("RADIO_BASILISK_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("RADIO_BASILISK_TEST_EXPLAIN")
