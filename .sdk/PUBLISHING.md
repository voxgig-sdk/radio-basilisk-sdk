...
|---|---|---|
| `ts/` | @voxgig-sdk/radio-basilisk-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/radio-basilisk-sdk \
      --repository voxgig-sdk/radio-basilisk-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/radio-basilisk-sdk` shows it, and
`npm trust revoke @voxgig-sdk/radio-basilisk-sdk --id=<id>` removes it.
