...
// RadioBasilisk SDK utility: graphql
//
...
class RadioBasiliskGraphql
{
    ...
    // equivalent.
    public static function body(RadioBasiliskContext $ctx): mixed
    {
    ...
    public static function errors(RadioBasiliskContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
