...
// RadioBasilisk SDK utility: fetcher

class RadioBasiliskFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RadioBasiliskSDK/1.0)';
    ...
    public static function call(RadioBasiliskContext $ctx, string $fullurl, array $fetchdef): array
    {
