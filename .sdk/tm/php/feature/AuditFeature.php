...
// RadioBasilisk SDK audit feature
...
class RadioBasiliskAuditFeature extends RadioBasiliskBaseFeature
{
    ...
    private function _emit(RadioBasiliskContext $ctx, string $outcome): void
    {
