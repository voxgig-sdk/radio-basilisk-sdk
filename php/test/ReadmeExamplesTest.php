...
// RadioBasilisk SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RadioBasiliskSDK::test)
...
{
    private const SDK_CLASS = 'RadioBasiliskSDK';
    ...
    private const SDK_BASE = 'radiobasilisk_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../radiobasilisk_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
