...
// RadioBasilisk SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = RadioBasiliskOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(RadioBasiliskOmni::structfix($now, Struct::undef()))
                        !== json_encode(RadioBasiliskOmni::structfix($val, Struct::undef()))) {
