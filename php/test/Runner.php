...
class RadioBasiliskTestRunner
{
    ...
    {
        $live = self::getenv('RADIO_BASILISK_TEST_LIVE');
        $override = self::getenv('RADIO_BASILISK_TEST_OVERRIDE');
        ...
        $explain = self::getenv('RADIO_BASILISK_TEST_EXPLAIN');
...
class_alias('RadioBasiliskTestRunner', 'Runner');
class_alias('RadioBasiliskHelpers', 'Helpers');
