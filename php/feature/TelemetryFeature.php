...
// RadioBasilisk SDK telemetry feature
...
class RadioBasiliskTelemetryFeature extends RadioBasiliskBaseFeature
{
    ...
    private function _close(RadioBasiliskContext $ctx, bool $ok): void
    {
