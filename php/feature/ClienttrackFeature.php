...
// RadioBasilisk SDK clienttrack feature
...
class RadioBasiliskClienttrackFeature extends RadioBasiliskBaseFeature
{
    ...
    public function PostConstruct(RadioBasiliskContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RadioBasilisk-SDK';
