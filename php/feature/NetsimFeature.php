...
// RadioBasilisk SDK netsim feature
...
class RadioBasiliskNetsimFeature extends RadioBasiliskBaseFeature
{
    ...
    private function _simulate(RadioBasiliskContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RadioBasiliskContext $ctx, array $applied): void
    {
        $client = $this->client;
