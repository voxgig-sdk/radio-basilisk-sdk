...
// RadioBasilisk SDK debug feature
...
class RadioBasiliskDebugFeature extends RadioBasiliskBaseFeature
{
    ...
    private function _finish(RadioBasiliskContext $ctx, bool $ok): void
    {
