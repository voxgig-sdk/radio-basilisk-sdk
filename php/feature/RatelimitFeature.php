...
// RadioBasilisk SDK ratelimit feature
...
class RadioBasiliskRatelimitFeature extends RadioBasiliskBaseFeature
{
    ...
    private function _acquire(RadioBasiliskContext $ctx): void
    {
    ...
    private function _track(RadioBasiliskContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
