...
// RadioBasilisk SDK cache feature
...
class RadioBasiliskCacheFeature extends RadioBasiliskBaseFeature
{
    ...
    private function _through(RadioBasiliskContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
