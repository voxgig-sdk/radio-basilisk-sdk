...
// RadioBasilisk SDK metrics feature
...
class RadioBasiliskMetricsFeature extends RadioBasiliskBaseFeature
{
    ...
    private function _record(RadioBasiliskContext $ctx, bool $ok): void
    {
