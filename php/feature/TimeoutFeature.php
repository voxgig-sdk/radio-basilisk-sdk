...
// RadioBasilisk SDK timeout feature
...
class RadioBasiliskTimeoutFeature extends RadioBasiliskBaseFeature
{
    ...
    private function _with_timeout(RadioBasiliskContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RadioBasiliskContext $_ctx, float $ms): void
    {
        $client = $this->client;
