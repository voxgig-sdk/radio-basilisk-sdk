...
// RadioBasilisk SDK rbac feature
...
class RadioBasiliskRbacFeature extends RadioBasiliskBaseFeature
{
    ...
    private function _required(RadioBasiliskContext $ctx): ?string
    {
    ...
    private function _reject(RadioBasiliskContext $ctx, string $required): void
    {
    ...
    private function _track(RadioBasiliskContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
