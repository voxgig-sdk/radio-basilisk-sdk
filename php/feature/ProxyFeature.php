...
// RadioBasilisk SDK proxy feature
...
class RadioBasiliskProxyFeature extends RadioBasiliskBaseFeature
{
    ...
    public function init(RadioBasiliskContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RadioBasiliskContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
