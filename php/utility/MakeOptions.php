...
// RadioBasilisk SDK utility: make_options

class RadioBasiliskMakeOptions
{
    ...
    public static function call(RadioBasiliskContext $ctx): array
    {
        ...
        //
        // `RadioBasiliskSchema::optspec()` is built from the model:
        ...
        $optspec = RadioBasiliskSchema::optspec();
