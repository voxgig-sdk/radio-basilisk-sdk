...
// RadioBasilisk SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class RadioBasiliskMakeRequest
{
    public static function call(RadioBasiliskContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new RadioBasiliskResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new RadioBasiliskResponse($fetched);
        } else {
