...
// RadioBasilisk SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class RadioBasiliskParam
{
    public static function call(RadioBasiliskContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = RadioBasiliskHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
