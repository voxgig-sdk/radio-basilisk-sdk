...
// RadioBasilisk SDK utility type

class RadioBasiliskUtility
{
    ...
    public static function copy(RadioBasiliskUtility $src): RadioBasiliskUtility
    {
        $u = new RadioBasiliskUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
