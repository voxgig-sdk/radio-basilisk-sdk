...
func registerSDKWords(r *eng.Registry, client *sdk.RadioBasiliskSDK) {
...
func runOp(client *sdk.RadioBasiliskSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
