...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/radio-basilisk` | `npm install @voxgig-sdk/radio-basilisk` |
| Python | `voxgig-sdk-radio-basilisk` | `pip install voxgig-sdk-radio-basilisk` |
| PHP | `voxgig-sdk/radio-basilisk` | `composer require voxgig-sdk/radio-basilisk` |
| Golang | `github.com/voxgig-sdk/radio-basilisk-sdk/go` | `go get github.com/voxgig-sdk/radio-basilisk-sdk/go` |
| Ruby | `voxgig-sdk-radio-basilisk` | `gem install voxgig-sdk-radio-basilisk` |
| Lua | `voxgig-sdk-radio-basilisk` | `luarocks install voxgig-sdk-radio-basilisk` |
